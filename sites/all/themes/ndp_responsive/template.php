 ...
 * @see page.tpl.php
 */
function ndp_responsive_preprocess_page(&$variables) {
  ...
  elseif (!empty($variables['page']['sidebar_first']) && empty($variables['page']['sidebar_second'])) {
    $variables['content_column_class'] = ' class="main-content-column col-sm-8 col-sm-push-4"';
    $variables['sidebar_first_class'] = ' class="sidebar sidebar-first col-sm-4 col-sm-pull-8"';
  }
  //SECOND SIDEBAR ONLY
  elseif (empty($variables['page']['sidebar_first']) && !empty($variables['page']['sidebar_second'])) {
...
function ndp_responsive_menu_link(array $variables) {
